...
#import "UIAlertView+RSTAdditions/UIAlertView+RSTAdditions.h"

#define SOFTWARE_UPDATE_ROOT_ADDRESS @"http://pixlrec.com/"
...
- (void)checkForUpdate
{
    ...
    NSString *address = [SOFTWARE_UPDATE_ROOT_ADDRESS stringByAppendingPathComponent:@"PixlRecUpdate.json"];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"Are you sure you want to update PixlRec?", @"")
                                                        message:NSLocalizedString(@"Click install on the next prompt to update PixlRec. Please make sure you have a good internet connection.", @"")
                                                       delegate:nil
