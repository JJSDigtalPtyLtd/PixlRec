...
+ (void)copyFileToCameraRoll:(NSURL *)fileURL  didFinishcompledBlock:(void (^)(void))aftersaved
{
    ...
    [library writeVideoAtPathToSavedPhotosAlbum:fileURL completionBlock:^(NSURL *assetURL, NSError *error) {
        ...
        if(error){
            ...
            {
                aftersaved();
                UIAlertView *savedAlert = [[UIAlertView alloc] initWithTitle:@"PixlRec" message:@"The video/s have been saved to your camera roll." delegate:nil cancelButtonTitle:@"Thanks!" otherButtonTitles:nil];
                [savedAlert show];
            }
        }
    }];
